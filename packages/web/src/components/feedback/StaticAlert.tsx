...
> = {
  error: {
    bgColour: 'bg-destructive/10',
    borderColour: 'border-destructive/20',
    textColour: 'destructive',
    iconColour: 'var(--color-destructive)',
    dismissHoverColour: 'hover:opacity-70',
    icon: Icons.ALERTCIRCLE,
  },
  warning: {
    bgColour: 'bg-warning/10',
    borderColour: 'border-warning/20',
    textColour: 'warning',
  ...
  success: {
    ...
    borderColour: 'border-success/20',
    textColour: 'success',
