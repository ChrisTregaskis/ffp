...
/** Row type for the location list — extends API response with Record for TanStack Table */
export type LocationRow = LocationListResponse & Record<string, unknown>;

/** Maps API response to row type */
export const toLocationRow = (location: LocationListResponse): LocationRow => ({
  ...location,
});
