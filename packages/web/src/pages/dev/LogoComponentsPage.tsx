...
export const LogoComponentsPage = (): JSX.Element => {
  const componentTabs: DemoTab[] = [
    ...
    { id: 'backgrounds', label: 'Backgrounds', content: <BackgroundsDemo /> },
    ...
    <ComponentPageWrapper maxWidth="6xl">
      ...
      <ComponentSection title="Component Demos">
        <Text as="p" styleProps={{ size: 'sm', colour: 'muted-foreground' }} className="mb-6">
          Click through each tab to explore logo variants, sizes, background combinations, and
...
const VariantsDemo: React.FC = () => (
  <div className="space-y-3">
    <Text as="p" styleProps={{ size: 'sm', colour: 'muted-foreground' }}>
      Five logo variants for different contexts and backgrounds.
    </Text>
...
const BackgroundsDemo: React.FC = () => (
  <div className="space-y-6">
    <Text as="p" styleProps={{ size: 'sm', colour: 'muted-foreground' }}>
      All variants shown against white, dark, and coloured backgrounds to demonstrate visibility.
    </Text>
    <div>
      <Text
        as="p"
...
const RealWorldDemo: React.FC = () => (
  <div className="space-y-6">
    <Text as="p" styleProps={{ size: 'sm', colour: 'muted-foreground' }}>
      Common logo usage patterns in real application layouts.
    </Text>
