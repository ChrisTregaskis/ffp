...
export const MotionShowcasePage = (): JSX.Element => {
  const componentTabs: DemoTab[] = [
    { id: 'card-animations', label: 'Card Animations', content: <CardAnimationsDemo /> },
    { id: 'transitions', label: 'Transitions', content: <TransitionsDemo /> },
    { id: 'interactions', label: 'Interactions', content: <InteractionsDemo /> },
    { id: 'panels-layout', label: 'Panels & Layout', content: <PanelsLayoutDemo /> },
  ];
    ...
    <ComponentPageWrapper>
      ...
      <ComponentSection title="Component Demos">
        <Text as="p" styleProps={{ size: 'sm', colour: 'muted-foreground' }} className="mb-6">
          Click through each tab to explore card animations, step transitions, interactive effects,
          and layout panels.
        </Text>
  ...
  {/* FFP content */}
          ...
          <div>
            ...
            <ul className="list-disc space-y-1 pl-5 text-sm">
              ...
              <li>
                <code className="rounded bg-muted px-1">delay</code>: Delay before animation starts
                (useful for staggering)
              </li>
            </ul>
          </div>
...
const CardAnimationsDemo: React.FC = () => (
  <div className="space-y-6">
    <Text as="p" styleProps={{ size: 'sm', colour: 'muted-foreground' }}>
      Animate card entry with fade-in, slide-up, and spring effects.
    </Text>
      ...
      <div>
        ...
        <CardTransition transitionKey={`step-${String(currentStep)}`} direction={direction}>
          ...
          >
            <div className="space-y-4">
              <Text as="p">
                CardTransition automatically animates in the correct direction based on navigation.
                Previous slides from left, Next slides from right.
              </Text>
  ...
  <Card title={\`Step \${currentStep}\`}>
    {/* Step content here */}
        ...
        <ul className="mt-4 list-disc space-y-1 pl-5 text-sm text-muted-foreground">
          ...
          <li>
            Use <code className="rounded bg-muted px-1">direction=&quot;backward&quot;</code> for
            previous/back navigation (slides from left)
          </li>
          <li>
...
// ============================================================================
// Interactions Demo (button click + hover + scale & fade)
// ============================================================================

const InteractionsDemo: React.FC = () => {
  const [showScaleFade, setShowScaleFade] = useState<boolean>(false);

  return (
    <div className="space-y-8">
      <Text as="p" styleProps={{ size: 'sm', colour: 'muted-foreground' }}>
        Interactive click, hover, and popover animations.
      </Text>
      ...
      <div>
        ...
        <Card className="mt-4">
          ...
          <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
            ...
            <li>
              Uses <code className="rounded bg-muted px-1">whileTap</code> prop internally to define
              the pressed state
            </li>
          ...
          <AnimatePresence>
            {showScaleFade && (
              <ScaleFade className="absolute left-0 top-2">
                <Card className="w-64">
                  <Text as="p" styleProps={{ size: 'sm' }}>
                    This is a popover with ScaleFade animation. It scales up from 95% whilst fading
                    in, creating a subtle but noticeable effect.
                  </Text>
                </Card>
              </ScaleFade>
            )}
...
// ============================================================================
// Panels & Layout Demo (drawer + width + vertical slide)
// ============================================================================

const PanelsLayoutDemo: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      <Text as="p" styleProps={{ size: 'sm', colour: 'muted-foreground' }}>
        Drawer panels, collapsible sidebars, and vertical slide animations.
      </Text>
              ...
              >
                <div className="flex h-full flex-col p-6">
                  <div className="mb-4 flex items-center justify-between">
                    <Title as="h3">
                      Drawer from {drawerPosition.charAt(0).toUpperCase() + drawerPosition.slice(1)}
                    </Title>
                    <Button
                      variant="neutral"
                      onClick={() => {
      ...
      <div>
        ...
        <div className="mt-4 flex gap-4">
          ...
          <Card className="flex-1">
            ...
            <Text as="p" styleProps={{ size: 'sm', colour: 'muted-foreground' }}>
              The sidebar smoothly transitions between expanded (240px) and collapsed (64px) states.
              Content visibility is handled separately with conditional rendering.
            </Text>
          </Card>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="relative mt-4 h-32 overflow-hidden rounded-lg border">
          <SlideVertical
          ...
          >
            <div className="bg-primary p-4 text-primary-foreground">
              ...
              <Text as="p" styleProps={{ size: 'sm' }} className="text-white/90">
                This header slides up and down based on visibility state. Perfect for sticky headers
                that hide on scroll.
              </Text>
            </div>
          </SlideVertical>
