...
export const assessmentCategories = [
  {
    ...
    description: 'Comprehensive assessment for lower back and upper back pain conditions',
    created_at: new Date(),
  },
  {
    ...
    description: 'Assessment for shoulder mobility, pain, and rotator cuff conditions',
    created_at: new Date(),
  },
  {
    id: categoryKneePain,
    ...
    description: 'Assessment for knee pain, mobility, and post-injury rehabilitation',
    created_at: new Date(),
  },
  {
...
export const assessmentTemplates = [
  {
    ...
    description: 'Initial assessment for lower back pain with scoring and program generation',
    version: 1,
    questions: {
      questions: [
        {
        ...
        },
        {
          id: 'q3',
          type: 'multi-choice',
          question: 'Which activities aggravate your back pain? (Select all that apply)',
          options: [
        ...
        },
        {
          id: 'q5',
          type: 'single-choice',
          question: 'Have you seen a healthcare professional about your back pain?',
          options: [
  ...
  },
  {
    ...
    description: 'Assess overall fitness level, goals, and exercise preferences',
    version: 1,
    questions: {
      questions: [
        {
        ...
        },
        {
          id: 'q5',
          type: 'multi-choice',
          question: 'Do you have any injuries or limitations? (Select all that apply)',
          options: [
...
export const videos = [
  // Lower Back Exercises
  {
    ...
    description: 'Gentle spinal mobility exercise to warm up the back and improve flexibility',
  ...
  },
  {
    id: randomUUID(),
    title: 'Pelvic Tilts',
    description: 'Core activation exercise to strengthen lower back and improve pelvic control',
  ...
  },
  {
    ...
    description: 'Core stability exercise targeting back, core, and improving balance',
  ...
  },
  {
    ...
    description: 'Core strengthening exercise focusing on lower back stability and coordination',
  ...
  },
  {
    id: randomUUID(),
    title: 'Glute Bridge',
    description: 'Hip and glute strengthening exercise that supports lower back health',
  ...
  // Leg Exercises
  {
    ...
    description: 'Fundamental lower body exercise building leg strength and mobility',
  ...
  },
  {
    id: randomUUID(),
    title: 'Lunges',
    description: 'Single-leg exercise improving balance, stability, and leg strength',
  ...
  // Upper Body Exercises
  {
    id: randomUUID(),
    title: 'Push-Ups',
    description: 'Classic upper body exercise strengthening chest, shoulders, and triceps',
  ...
  },
  {
    id: randomUUID(),
    title: 'Bicep Curls',
    description: 'Isolation exercise targeting bicep muscles with controlled movement',
  ...
  },
  {
    id: randomUUID(),
    title: 'Side Plank',
    description: 'Lateral core strengthening exercise for obliques and stability',
  ...
  },
  {
    ...
    description: 'Rotational core exercise targeting obliques and improving coordination',
  ...
  // Flexibility/Mobility
  {
    ...
    description: 'Static stretch for hamstring flexibility and lower back relief',
  ...
  },
  {
    ...
    description: 'Stretch targeting hip flexors to improve mobility and reduce lower back tension',
  ...
  },
  {
    id: randomUUID(),
    title: "Child's Pose",
    description: 'Restorative yoga pose for back relaxation and gentle stretching',
