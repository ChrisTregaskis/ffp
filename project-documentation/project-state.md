...
| 3   | FFP-284 | Generate and apply database migration           | To Do  | `pnpm db:generate` then `pnpm db:migrate`  |
| 4   | FFP-285 | Create Zod validation schemas                   | To Do  | In `packages/core/src/schemas/`            |
