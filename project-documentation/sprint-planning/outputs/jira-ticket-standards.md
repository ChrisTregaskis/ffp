...
- **Testing Focus**: Minimum 2 functional tests per User Story, 30% coverage Phase 1 target
...
- [ ] Unit tests achieve 30% coverage on core business logic
...
8. Configure coverage thresholds (30% for Phase 1)
...
- [ ] Coverage thresholds enforced (30% global)
...
- [ ] **Testing**
  ...
  - [ ] Test coverage meets 30% threshold (Phase 1)
